...
\def\myumlnode@[#1]<#2>[#3]#4#5{%
	...
	\fpRegSet{linewidth}{\pst@number\pslinewidth}%
	\fpRegDiv{linewidth}{unit}%
	\fpRegSet{framesep}{\pst@number\psframesep}%
	\fpRegDiv{framesep}{unit}%
	\fpRegSet{mid}{2}%
	\fpRegSet{midlinewidth}{0}%
	\fpRegAdd{midlinewidth}{linewidth}%
	\fpRegDiv{midlinewidth}{mid}%
	...
	\fpRegSub{minx}{framesep}%
	\fpRegSub{minx}{midlinewidth}%
	\fpRegSet{maxx}{0}%
	\fpRegAdd{maxx}{midwidth}%
	\fpRegAdd{maxx}{framesep}%
	\fpRegAdd{maxx}{midlinewidth}%
	\fpRegSet{miny}{0}%
	\fpRegSub{miny}{midheight}%
	\fpRegSub{miny}{framesep}%
	\fpRegSub{miny}{midlinewidth}%
	\fpRegSet{maxy}{0}%
	\fpRegAdd{maxy}{midheight}%
	\fpRegAdd{maxy}{framesep}%
	\fpRegAdd{maxy}{midlinewidth}%
	\fpRegSet{sminx}{0}%
	\fpRegAdd{sminx}{minx}%
	...
	\fpRegSub{psminx}{midlinewidth}%
	\fpRegSet{psmaxx}{0}%
	\fpRegAdd{psmaxx}{smaxx}%
	\fpRegAdd{psmaxx}{midlinewidth}%
	\fpRegSet{psminy}{0}%
	\fpRegAdd{psminy}{miny}%
	\fpRegSub{psminy}{midlinewidth}%
	\fpRegSet{psmaxy}{0}%
	\fpRegAdd{psmaxy}{smaxy}%
	\fpRegAdd{psmaxy}{midlinewidth}%
...
\def\myumlcomponent@[#1]<#2>[#3]#4#5{%
	...
	\fpRegAdd{portheight}{framesep}%
	\fpRegSet{portsep}{0}%
	\fpRegAdd{portsep}{framesep}%
	\fpRegDiv{portsep}{mid}%
	\setbox\my@current@box=\hbox{\my@current@text}%
	...
	\fpRegSub{psminx}{framesep}%
	\fpRegSub{psminx}{linewidth}%
	\fpRegSet{psmaxx}{0}%
	...
	\fpRegSub{psminy}{framesep}%
	\fpRegSub{psminy}{linewidth}%
	\fpRegSet{psmaxy}{0}%
	...
	\begin{pspicture}(\my@current@pspicture@minx,\my@current@pspicture@miny)(\my@current@pspicture@maxx,\my@current@pspicture@maxy)%
		...
		\ifstrempty{#5}%
			{%
				...
				\fpRegAdd{minx}{midlinewidth}%
				\fpRegSet{maxx}{0}%
				\fpRegAdd{maxx}{minx}%
				\fpRegAdd{maxx}{portwidth}%
				\fpRegSet{maxy}{0}%
				\fpRegAdd{maxy}{psmaxy}%
				\fpRegSub{maxy}{linewidth}%
				\fpRegSub{maxy}{framesep}%
				\fpRegSub{maxy}{midlinewidth}%
				\fpRegSet{miny}{0}%
				\fpRegAdd{miny}{maxy}%
				...
				\uput{\psframesep}[-135](\my@current@pspicture@maxx,\my@current@pspicture@maxy){%
					...
					\fpRegDiv{componentsize}{unit}%
					\fpRegAdd{componentsize}{framesep}%
					\fpRegAdd{componentsize}{framesep}%
					\fpRegAdd{componentsize}{linewidth}%
					\fpRegSet{scale}{0}%
					\fpRegAdd{scale}{framesep}%
