%% $Id: pst-mirror.pro 377 2010-08-30 12:15:40Z herbert $
%%
...
% sommets apres rotation et translation
...
% centres de faces apres transformations
...
%
/tx@WARP{
%% D'apres un fichier original de
%%(c) P. Kleiweg 1997
%% adapte par :
%% Manuel Luque
%% Arnaud Schmittbuhl
...
%% pour passer des coordonnees du plan aux coordonnees
%% (x,y,z) du repare absolu
%% les coordonnees spheriques du vecteur normal
%% au plan
%% l'origine du plan
/zO' exch def
/yO' exch def
