...
\def\pst@logicori[#1]#2(#3)#4{{%
  ...
  % Inputs
    \ifcase\psk@ninputs\or
	\ifPst@inputa
  	\psline(0,1)(1.08,1)\pnode(0,1){#4A} % Input A
	\ifPst@invertinputa
    ...
    \or
	\ifPst@inputa
	\psline(0,1.5)(1,1.5)\pnode(0,1.5){#4A} % Input A
	\ifPst@invertinputa
	\pscircle[fillstyle=solid](! 1 \space\psk@bubblesize\space sub 1.5){{\psk@bubblesize}} % Invert Input A
	\fi
	\fi
	\ifPst@inputb
	\psline(0,0.5)(1,0.5)\pnode(0,0.5){#4B} % Input B
	\ifPst@invertinputb
	\pscircle[fillstyle=solid](! 1 \space\psk@bubblesize\space sub 0.5){{\psk@bubblesize}} % Invert Input B
	\fi
	\fi
	...
	% Output
	\ifPst@iec
		\psline(2.5,1)(3.5,1)\pnode(3.5,1){#4O}
	\else
		\psline(3.5,1)(4.5,1)\pnode(4.5,1){#4O}
	\fi
	\ifPst@invertoutput
		\ifPst@iecinvert
			\psline(2.5,1.25)(3,1)\pnode(3,1){#4A}
		\else
			\ifPst@iec
				\pscircle[fillstyle=solid](! 2.5 \space\psk@bubblesize\space add 1){{\psk@bubblesize}} % Invert Output
			\else
